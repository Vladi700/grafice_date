...
date axis; the remaining column headers are the cities/counties. Some sheets
use trimester dates ("YYYY-TQ") instead of months -- the x-axis label adapts.
"""
...
OUT = HERE / "oferte_constructii" / "oferte_dashboard.html"

# Google Sheet configuration
SPREADSHEET_ID = "1GDH4Gw0CPnWYwyyE_f2GI9rUmPzf5MxIdj028wg-Bos"  # Replace with actual ID from URL
# Map sheet names to their GIDs (get from URL: .../edit#gid=123456789)
SHEET_GIDS = {
    "aut_constr": "1494021535",
    "locuinte_terminate_urban": "251628818",
    "locuinte_terminate_rural": "1309891860",
}
# Sheets whose date axis is in trimesters ("YYYY-TQ") instead of months
TRIMESTER_SHEETS = {"locuinte_terminate_urban", "locuinte_terminate_rural"}
