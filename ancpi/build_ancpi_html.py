...
date axis; the remaining column headers are the cities/counties. The
output dashboard mirrors the layout used by build_iga_html.py.
"""
...
OUT = HERE / "ancpi" / "ancpi_dashboard.html"

# Google Sheet configuration
SPREADSHEET_ID = "1wMZHn5_QLXa7TIOWvtYxhVFsz5QJrgF1U7WA3tZeeJ0"  # Replace with actual ID from URL
# Map sheet names to their GIDs (get from URL: .../edit#gid=123456789)
SHEET_GIDS = {
    "Ipoteci Active": "86282713",
    "Intravilan cu Constructii": "2094781568",
    "Intravilan fara Constructii": "1529261892",
    "Nr Unitati Individuale": "860187221",
    "Resedinta Intravilan cu Constru": "2018912671",
    "Resedinta Intravilan fara Const": "1384291243",
    "Resedinta Nr Unitati Individual": "1625412040",
}
...
<head>
<meta charset="utf-8" />
<title>ANCPI — Dashboard interactiv</title>
...
<body>
<header>
  <h1>ANCPI — Grafice interactive</h1>
